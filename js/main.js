...
const collisionCanvas = document.getElementById('collisionCanvas'); // collision detection canvas
...
function drawGameOver() {
    ...
    ctx.fillStyle = 'white';
    ctx.fillText('Game Over', canvas.width * 0.5, canvas.width * 0.5);
    ctx.font = '50px Impact';
}
...
function animate(timestamp) {
    ...
    if (timeToNextRaven > ravenInterval) {
        ...
        timeToNextRaven = 0;
        ravens.sort(function (a, b) { // sort raven big to front, small to back
